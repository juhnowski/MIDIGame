 ...
 * @author ilya
 */
public class GameReceiver 	implements	Receiver
{
	...
	private boolean			m_bPrintTimeStampAsTicks;
        private GameForm                m_gf;
        

	public GameReceiver(GameForm gf, PrintStream printStream)
	{
		this(gf, printStream, false);
	}
	...
	public String decodeMessage(ShortMessage message)
	{
		...
		case 0x90:
			strMessage = "note On " + getKeyName(message.getData1()) + " velocity: " + message.getData2();
                        m_gf.onNote(getKeyName(message.getData1()));
			break;
